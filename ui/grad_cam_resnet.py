...
def save_and_display_gradcam(img_path, heatmap, cam_path="G:/My Drive/FP/ui/util/cam_resnet.jpg", alpha=0.4):
...
def predict_and_visualize_resnet(path):
  # path = "COVID-19_Radiography_Dataset/Normal/images/Normal-5.png"
